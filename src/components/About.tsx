...
export default function AboutUs() {
  return (
    <section className="w-full  flex flex-col items-center justify-center py-12 px-2">
      ...
      {/* Border Wrapper */}
      <div className="relative w-full container mx-auto rounded-3xl overflow-visible shadow-2xl backdrop-blur-md px-2 sm:px-4 md:px-8 py-8">
        {/* SVG Border */}
        <svg
        ...
        <div className="relative flex flex-col lg:flex-row items-center justify-center gap-6 px-2 py-8 z-20">
          {/* Left Character */}
          <div className="hidden lg:block absolute -left-9 z-30">
            <Image
          ...
          {/* Right Character */}
          <div className="hidden lg:block absolute -right-18 z-30">
            <Image
              src="/about/AxeCharacter.png"
              alt="Right Character"
              width={420}
