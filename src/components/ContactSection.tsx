      ...
      <div className="max-w-5xl mx-auto text-center pt-24 pb-12 px-4 sm:px-6 md:pt-28 md:pb-16">
        ...
        <form className="space-y-4" onSubmit={sendEmail}>
          ...
          <div className="flex justify-center md:justify-start">
            <button
              type="submit"
              className="bg-gradient-to-r from-red-600 to-yellow-400  cursor-pointer px-8 py-2 text-black font-semibold rounded-full mt-2 w-full sm:w-auto md:w-auto max-w-xs"
            >
              SEND MESSAGE
            </button>
          </div>
